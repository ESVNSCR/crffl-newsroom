    ...
    <>
      <div className="rounded-2xl bg-gradient-to-br from-[#d4af37]/15 via-[#121824] to-[#121824] border border-[#d4af37]/40 p-6 space-y-4 shadow-xl">
        ...
        <p className="text-xs text-gray-300 leading-relaxed">
          Get real-time email or SMS dispatches whenever new columnist articles drop, power rankings are published, or sportsbook bets are posted and paid out.
        </p>
        ...
        <div className="grid grid-cols-2 gap-1.5 pt-1">
          ...
          <div className="flex items-center gap-1 text-[11px] text-gray-300 font-medium bg-black/40 px-2.5 py-1.5 rounded-lg border border-gray-800">
            <span className="text-[#d4af37]">✓</span> New Betting Lines
          </div>
          <div className="flex items-center gap-1 text-[11px] text-gray-300 font-medium bg-black/40 px-2.5 py-1.5 rounded-lg border border-gray-800">
            <span className="text-[#d4af37]">✓</span> Bet Payouts
          </div>
        </div>
        ...
        >
          <span>Sign Up For League Alerts →</span>
        </button>
      </div>
